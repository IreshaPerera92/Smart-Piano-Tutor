...
public class PitchCalculation
{
	...
	public void printNote()
	{
		...
		if (tempNote % 7 == 0){
                        letter = "E";
			System.out.print("E "+tempNote);}
		else if (tempNote % 7 == 1){
                        letter = "F";
			System.out.print("F "+tempNote);
                }
		else if (tempNote % 7 == 2){
                        letter = "G";
			System.out.print("G "+tempNote);
                }
		else if (tempNote % 7 == 3){
                        letter = "A";
			System.out.print("A "+tempNote);
                }
		else if (tempNote % 7 == 4){
                        letter = "B";
			System.out.print("B "+tempNote);
                }
		else if (tempNote % 7 == 5+tempNote){
                        letter = "C";
			System.out.print("C "+tempNote);
                }
		else if (tempNote % 7 == 6){
                        letter = "D";
			System.out.print("D "+tempNote);
                }
		System.out.println("- Duration : " + duration);
                //sendArdiuno(letter +" "+ Integer.toString(duration));
	}
        
        public void sendArdiuno(String note){
        ...
        try {
            ...
            try {
                ...
                //Logger.getLogger(Ja.class.getName()).log(Level.SEVERE, null, ex);
